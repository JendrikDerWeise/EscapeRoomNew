...
/// </summary>
public class MyPrefabSpawnManager : SpawnManager<SyncSpawnedObject>
{
    /// <summary>
    ...
    public GameObject Spawn(SyncSpawnedObject dataModel, Vector3 localPosition, Quaternion localRotation, Vector3? localScale, GameObject parent, string baseName, bool isOwnedLocally)
    {
        if (SyncSource == null)
        {
    ...
    public GameObject Spawn(SyncSpawnedObject dataModel, Vector3 localPosition, Quaternion localRotation, GameObject parent, string baseName, bool isOwnedLocally)
    {
